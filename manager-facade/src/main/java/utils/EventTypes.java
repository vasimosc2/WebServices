...
public class EventTypes {
    ...
    public static final String MANAGER_REPORTS_REQUESTED = "ManagerReportsRequested";

    public static final String MANAGER_REPORTS_GENERATED = "ManagerReportsGenerated";
